/**
 * Live DOM audit for www.expedia.com urgency / social-proof widgets.
 * Headed by default. No sign-in or checkout.
 * Run: node scripts/audit-expedia.mjs
 * Writes temp/expedia-audit.json
 */
...
const outPath = resolve(root, 'temp/expedia-audit.json');
const HOST = 'https://www.expedia.com';
