/**
 * Live DOM audit for www.hotels.com urgency / social-proof widgets.
 * Headed by default. No sign-in or checkout.
 * Run: node scripts/audit-hotels.mjs
 * Writes temp/hotels-audit.json
 */
...
const outPath = resolve(root, 'temp/hotels-audit.json');
const HOST = 'https://www.hotels.com';
