/**
 * www.expedia.com SERP scarcity — headed Playwright (MV3). Not CI-blocking.
 */
...
const SERP =
  'https://www.expedia.com/Hotel-Search?destination=New%20York&startDate=2026-10-16&endDate=2026-10-17&adults=2&rooms=1';
const HOST = 'www.expedia.com';
...
const context = await chromium.launchPersistentContext(resolve(root, `.verify-expedia-${Date.now()}`), {
  headless,
