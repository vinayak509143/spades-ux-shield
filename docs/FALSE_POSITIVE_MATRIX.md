...
| Shein | Cart + All Sale (manual, 2026-09-24) | First-paint `img[width="12"][height="12"]` whose alt is “user add to cart” or “+ sold”, plus the `span.label-text` beside it | **Rule** — icon included; price, % off, free-shipping threshold, points-if-late stay (`docs/shein-audit.md`) |
